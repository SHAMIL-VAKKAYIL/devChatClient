...
import { features } from '@/store/chatSlice'
  ...
  return (
    <nav className=' rounded-xl max-w-xs bg-bg2  py-2 px-4 text-secondary overflow-hidden flex flex-col items-center '>
      ...
      <div className='border-t-2 mt-3 flex border-[#585656] '>
        <button onClick={()=>features('Group chat')} className=' flex m-auto  rounded-full p-3 object-contain  bg-[#424040] text-[#0bba48]  hover:bg-[#0bba48]  hover:text-white transition-all duration-300 ease-in-out mt-4  '>
